;(function ( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function () {
        ...
        if($('#slidepanel').length == 0){
           var panel_html = '<div id="slidepanel" class="cb_slide_panel"><div class="wrapper"><a href="index.html" class="close">Close</a><div class="inner"><div class="wrapper"><a href="index.html"><img class="logo" src="images/MyLogo.png" alt="Logo Image"></a><ul class="links"><li><a href="portfolio.html">Portfolio</a></li><li><a href="https://mawatts.github.io/about-me/index.html">About Me</a></li><li><a href="#">Blog</a></li><li><a href="contact-me.html">Contact Me</a></li></ul></div></div></div></div>';
